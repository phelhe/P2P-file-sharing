		...
		try {
			while(reading) {
				...
				if(message.equals("register")) {
					...
					while(cu.clientRegisteringStatus()) {
						...
						if(message.equals("done")) {
							System.out.println("Client done registering");
							cu.registerFiles(filesList);//let the utilities tell the server
							cu.clientDoneRegistering();
						}
						else {
							System.out.println("client wants to register: " + message);
				...
				if(message.equals("unregister")) {
					System.out.println("client wants to unregister a file");
				...
				if(message.equals("search")) {
					System.out.println("client wants a file");
